...
export default function Modal({ data, close }) {
    ...
    return (
        <Container>
            ...
            <footer>
                {
                    data.link && <a href={data.link} target="_blank" rel="noopener noreferrer">Link Oficial</a>
                }

                {
                    data.link2 && <a href={data.link2} target="_blank" rel="noopener noreferrer">Link Pirata</a>
                }
            </footer>
        </Container>
    );
